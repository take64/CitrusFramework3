...
use Citrus\CitrusAws;
use Citrus\CitrusConfigure;
use Citrus\CitrusObject;

class CitrusAwsCloudwatch extends CitrusObject
{
    ...
    {
        // AWSセットアップ
        CitrusAws::initialize();

        $configure = CitrusConfigure::configureMerge(CitrusAws::CONFIGURE_KEY, $configure, $configure);
