...
class CitrusFormmap
{
     ...
     *
     * @access  public
     * @since   0.0.9.8 2009.12.18
     * @version 0.0.9.8 2009.12.18
...
//
//        // cache
//        $cache  = ($xpath->query('/citrus2/formmap/property[@name="cache"]/@value')->length > 0 ?
//            $xpath->query('/citrus2/formmap/property[@name="cache"]/@value')->item(0)->value : '');
//        if (isset($cache) === true && $cache == 'enable' && CitrusCache::isEnable() === true)
//        {
//            self::$is_cache = true;
//        }
    }
        ...
        foreach ($request_list as $ky => $vl)
        {
            ...
            if (preg_match('/.*(_y|_x)$/i', $ky) > 0)
            {
                ...
                if (isset($this->elements[$prefix.$ky]) === true)
                {
                    ...
                    {
                        $this->elements[$prefix.$ky]->value = array();
                    }
